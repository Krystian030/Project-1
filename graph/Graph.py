...
class Graph:
    ...
    def visualizationGraph(self):
        ...
        pos = nx.spectral_layout(self.graph, k=10, iteration=100)
        ...
        def animate(frame):
            ...
            if self.color_map[self.actual_node]=="green" and self.actual_node<self.n:
                ...
                self.actual_node+=1
            nx.draw(self.graph, pos, node_size=self.size_map, node_color=self.color_map, alpha=0.8, with_labels=True, font_size=10)
