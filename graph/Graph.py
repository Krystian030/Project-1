    ...
    def visualizationGraph(self):
        ...
        def animate(frame):
            if self.actual_node < self.n:
                ...
                nx.draw(self.graph, self.position, node_size=self.size_map, node_color=self.color_map, font_size=7, with_labels=True, labels=self.labels, width=list(self.width.values()))
